...
<body>
    <div class="container-fluid">
                            ...
                            <tbody>
                                <?php foreach ($contacts as $contact) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a onclick="return Del('<?php echo $contact['id'] ?>')" href="./delete-contact.php?id=<?php echo $contact["id"] ?>" style="text-decoration: none;">
        ...
        <script>
            function Del() {
                return confirm("Bạn có muốn xóa liên hệ này không?");
            }
        </script>
    </div>
